...
T MessageQueue<T>::receive()
{
    ...
    _condition_variable.wait(lck, [this] {return !_queue.empty();});
...
void TrafficLight::cycleThroughPhases()
{
    ...
    while (true) {
        ...
        if (timeSinceLastUpdate >= cycleDuration) {
            ...
            auto msg_send = std::async(std::launch::async, &MessageQueue<TrafficLightPhase>::send, _msgQueue, std::move(msg));
            msg_send.wait();
